/**
 * Alert Level Enum
 * Ported from webui/src/app/enums/alert-level.enum.ts
 */
...
/**
 * Alert Class Name Enum
 * Ported from webui/src/app/enums/alert-class-name.enum.ts
...
export enum AlertClassName {
  ...
  JbofInvalidData = 'JBOFInvalidInvalidData',
