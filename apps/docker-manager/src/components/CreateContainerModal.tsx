    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid #e5e5ea', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ fontSize: 18, fontWeight: 700 }}>创建容器</div>
          <div style={{ fontSize: 14, color: '#8e8e93' }}>步骤 {props.step} / 3</div>
        </div>
        ...
        <div style={{ padding: '16px 24px', background: '#f9f9f9', borderTop: '1px solid #e5e5ea', display: 'flex', justifyContent: 'space-between' }}>
           {props.step > 1 ? (
